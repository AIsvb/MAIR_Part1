...
class DialogManagementSystem(StateMachine):
    ...
    def __init__(self):
        ...
        self.state_transition_dict = { welcome : { 'informFood' :  welcome_to_foodtype, 'informArea' : welcome_to_area, 'informPrice' : welcome_to_price,  'informLookup' : welcome_to_lookup},
                                       ask_foodtype : { 'informArea' : foodtype_to_area, 'informPrice' : foodtype_to_pricerange, 'informLookup' : foodtype_to_lookup },
                                       ask_area : { 'informPrice': area_to_pricerange, 'informLookup': area_to_lookup },
                                       ask_pricerange : { 'informLookup' : area_to_lookup},
                                       lookup_restaurant_suggestion : { 'informOffer' : lookup_to_offer, 'informNewpref' : lookup_to_newpreferences},
                                       offer_suggestion : { 'affirmOffer' : offer_to_exit, 'requestAlternative' : offer_to_lookup },
                                       retrieve_address : { 'requestAddress' : offer_to_postcode, 'requestPhone' : offer_to_phone, 'requestPostcode' : offer_to_postcode, 'requestAll' : offert_to_returninfo},
                                       retrieve_phonenumber : { 'requestPostcode' : phone_to_postcode, 'requestreturnInfo' : phone_to_returninfo},
                                       retrieve_postcode: { 'requestReturninfo' : postcode_to_returninfo},
                                       ask_newpreferences : { 'startoverFood' :  newpref_to_foodtype, 'startoverArea' : newpref_to_area, 'startoverPrice' : newpref_to_price,  'startoverLookup' : newpref_to_lookup}
                                       system_exit : { 'thankyou': returninfo_to_exit}
                                    }
    ...
    # Welcome (all transitions originated from Welcome State)
    ...
    phone_to_returninfo = _.retrieve_phone.to(_.return_information, cond="postcode_not_requested")
